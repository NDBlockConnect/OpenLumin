...
public interface LuminPlatform {
     ...
     */
    GpuBufferSlice writeTransform(org.joml.Matrix4fc modelView, org.joml.Vector4fc colorModulator,
                                   org.joml.Vector3fc modelOffset, org.joml.Matrix4fc textureMatrix,
                                   float lineWidth);
