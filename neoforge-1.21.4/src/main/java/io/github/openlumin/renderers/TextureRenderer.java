...
public class TextureRenderer implements IRenderer {
    ...
    private LuminTexture loadTexture(ResourceLocation ResourceLocation, boolean useLinearFilter) {
        ...
        // NeoForge不支持AbstractTexture的GPU纹理方法
        /*
        try {
        ...
        */
        ...
        // NeoForge不支持RenderSystem.getDevice()和相关GPU API
        // 返回一个占位的LuminTexture
        GpuTexture texture = new GpuTexture(image.getWidth(), image.getHeight());
        GpuTextureView view = texture.createView();
