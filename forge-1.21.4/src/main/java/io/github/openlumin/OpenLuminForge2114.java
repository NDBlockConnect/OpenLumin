...
/**
 * forge-1.21.4 渲染管线入口（OpenGL stubs 路径，编译占位）。
 * 注意：forge-1.21.4 使用旧版 Forge API，现代 GPU 路径通过 stubs 确保编译通过。
 */
@Mod("openlumin")
public class OpenLuminForge2114 {
    ...
    public OpenLuminForge2114(IEventBus modEventBus) {
    ...
    private static void render2D(int screenW, int screenH) {
        ...
        layer.addText("OpenLumin Forge 1.21.4", x, y + 205f, 1.0f, Color.WHITE, testFont());
