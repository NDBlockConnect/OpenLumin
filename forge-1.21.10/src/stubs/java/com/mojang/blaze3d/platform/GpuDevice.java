...
public class GpuDevice {
    ...
    public com.mojang.blaze3d.buffers.GpuBuffer createBuffer(Supplier<String> name, int usage, long size) {
        // NeoForge使用不同的API
        return new com.mojang.blaze3d.buffers.GpuBuffer((int) size, usage);
    }
