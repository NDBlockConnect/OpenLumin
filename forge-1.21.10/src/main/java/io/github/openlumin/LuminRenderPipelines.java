...
public class LuminRenderPipelines {
    ...
    public final static RenderPipeline ELLIPSE = RenderPipeline.builder(NO_BLEND_DEPTH_SNIPPET)
    ...
    public final static RenderPipeline ARC = RenderPipeline.builder(NO_BLEND_DEPTH_SNIPPET)
