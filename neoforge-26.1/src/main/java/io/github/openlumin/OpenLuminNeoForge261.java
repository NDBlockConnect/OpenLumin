...
public class OpenLuminNeoForge261 {
    ...
    public OpenLuminNeoForge261(IEventBus modEventBus, Dist dist) {
        if (dist.isClient()) {
            // 注册客户端事件到游戏事件总线
    ...
    public static class ClientEvents {
         ...
         *
         * 注意：RenderLevelStageEvent 在 NeoForge 26.1 中可能不存在或签名不同。
    ...
    private static void render2D(int screenW, int screenH) {
        ...
        layer.addText("OpenLumin 26.1", x, y + 460f, 1.0f, Color.WHITE, testFont());
