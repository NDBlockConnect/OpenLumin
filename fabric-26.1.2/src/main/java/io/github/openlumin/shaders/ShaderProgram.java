...
/**
 * OpenGL Shader Program 包装类（26.1 基线，资源标识使用 Identifier）
...
public class ShaderProgram implements AutoCloseable {
     ...
     */
    public static ShaderProgram load(Identifier vertexShaderPath, Identifier fragmentShaderPath, ResourceManager resourceManager) throws IOException {
            ...
            if (trimmed.startsWith("#moj_import")) {
                ...
                if (start >= 0 && end > start) {
                    ...
                    if (colon > 0) {
                        ...
                        Identifier includeLoc = Identifier.fromNamespaceAndPath(
     ...
     * 从资源加载 shader 源码
     */
    private static String loadShaderSource(Identifier location, ResourceManager resourceManager) throws IOException {
