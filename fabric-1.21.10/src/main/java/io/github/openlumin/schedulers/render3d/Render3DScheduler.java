...
public final class Render3DScheduler {
    ...
    private static final RenderPipeline LINES_PIPELINE = RenderPipeline.builder(LuminRenderPipelines.WORLD_LINES_SNIPPET)
            ...
            .withVertexShader(ResourceLocation.fromNamespaceAndPath("minecraft","core/rendertype_lines"))
            .withFragmentShader(ResourceLocation.fromNamespaceAndPath("minecraft","core/rendertype_lines"))
            .withCull(false)
