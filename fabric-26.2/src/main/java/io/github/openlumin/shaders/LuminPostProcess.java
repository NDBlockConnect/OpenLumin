...
public final class LuminPostProcess {
     ...
     * @see Sandbox 内置预设常量
     */
    public static void sandbox(Identifier fragmentShader, double mouseX, double mouseY) {
    ...
    /**
     * 内置 GLSL 动态背景预设的 Identifier 常量，与 {@link #sandbox} 配合使用。
     */
    public static final class Sandbox {
        private Sandbox() {}

        /** 海平面波浪效果 */
        public static final Identifier SEA         = GlslSandBox.SEA_LEVEL;
        /** 流动云彩效果 */
        public static final Identifier CLOUDS      = GlslSandBox.CLOUDS;
        /** 外星地形效果 */
        public static final Identifier ALIEN       = GlslSandBox.ALIEN_TERRAIN;
        /** 地狱烈焰效果 */
        public static final Identifier INFERNO     = GlslSandBox.INFERNO;
        /** 星球轨道效果 */
        public static final Identifier PLANET      = GlslSandBox.PLANET;
        /** 黑洞效果 */
        public static final Identifier BLACK_HOLE  = GlslSandBox.BLACK_HOLE;
        /** Minecraft 风格像素效果 */
        public static final Identifier MINECRAFT   = GlslSandBox.MINECRAFT;
    }
