...
public class BlurShader {
    ...
    public void render3DBox(AABB box, double blurStrength) {
        ...
        BufferBuilder buffer = new BufferBuilder(new ByteBufferBuilder(64 * 1024), PrimitiveTopology.QUADS, DefaultVertexFormat.POSITION_COLOR);
        ...
        var autoIndices = RenderSystem.getSequentialBuffer(PrimitiveTopology.TRIANGLES);
