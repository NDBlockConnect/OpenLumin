...
public class TextureRenderer implements IRenderer {
    ...
    public void addQuadTexture(Identifier texture, float x, float y, float w, float h, float u0, float v0, float u1, float v1, Color color) {
        addRoundedTexture(texture, x, y, w, h, 0f, u0, v0, u1, v1, color, false);
    }

    public void addQuadTexture(Identifier texture, float x, float y, float w, float h, float u0, float v0, float u1, float v1, Color color, boolean linear) {
        addRoundedTexture(texture, x, y, w, h, 0f, u0, v0, u1, v1, color, linear);
    }

    public void addRoundedTexture(Identifier texture, float x, float y, float w, float h, float r, float u0, float v0, float u1, float v1, Color color) {
        addRoundedTexture(texture, x, y, w, h, r, u0, v0, u1, v1, color, false);
    }

    public void addRoundedTexture(Identifier texture, float x, float y, float w, float h, float r, float u0, float v0, float u1, float v1, Color color, boolean linear) {
    ...
    public void addRoundedTexture(Identifier texture, float x, float y, float w, float h, float rTL, float rTR, float rBR, float rBL, float u0, float v0, float u1, float v1, Color color, boolean linear) {
    ...
    public void addRotatedTexture(Identifier texture, float x, float y, float w, float h, float u0, float v0, float u1, float v1, Color color, float ox, float oy, float deg, boolean linear) {
    ...
    private LuminTexture loadTexture(Identifier id, boolean linear) {
